...
//    }
    ...
    public static List<String[]> coveragePlanCode(String grpno) {
        ...
        String sql = "SELECT GCARR,GGPNM,GPL1,GPL2,GPL3,GPL4,GPL5,GPL6,GPL7,GPL8,GPL9,GPL10,GPL11,GPL12,GPL13,"
                + "GPL14,GPL15,GPL16,GPL17,GPL18,GPL19,GPL20,GPL21,GPL22,GPL23,GPL24,GPL25,GPL26,GPL27,GPL28,"
                + "GPL29,GPL30,GPL31,GPL32,GPL33,GPL34,GPL35,GPL36,GPL37,GPL38,GPL39,GPL40,GPL41,GPL42,GPL43,"
                + "GPL44,GPL45,GPL46,GPL47,GPL48,GPL49,GPL50 FROM QTEMP.GRPMST WHERE GGRPNO='" + grpno+ "'";
        resultList = iSeries.executeSQLByAlias(sql, alias, file);
